...
class MinMax1_TPWE(MinMax):
    ...
    """
    def __init__(self, depth=1, evaluator=Evaluator_TPWE(corner=50, c=-20, a1=0, a2=-1, b=-1, x=-25, o=-5, wp=5, ww=10000, wpy=47, wy=28, wpwin=0, wwin=-3, wb=0, ws1=10, ws2=10, ws3=10, ws4=10, ws5=10, ws6=10, ws7=10)):
        super().__init__(depth, evaluator)
