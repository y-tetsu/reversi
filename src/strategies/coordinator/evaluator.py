...
class Evaluator_TPWE(AbstractEvaluator):
    ...
    """
    def __init__(self, size=8, corner=50, c=-20, a1=0, a2=-1, b=-1, x=-25, o=-5, wp=5, ww=10000, wpy=47, wy=28, wpwin=0, wwin=-3, wb=0, ws1=100, ws2=100, ws3=100, ws4=100, ws5=100, ws6=100, ws7=100):
        self.t = Evaluator_T(size, corner, c, a1, a2, b, x, o)
        self.p = Evaluator_P(wp)
        self.w = Evaluator_W(ww)
