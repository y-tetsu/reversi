...
from strategies.coordinator.evaluator import Evaluator_T, Evaluator_P, Evaluator_O, Evaluator_W, Evaluator_N, Evaluator_TP, Evaluator_TPO, Evaluator_NW, Evaluator_PW, Evaluator_TPW, Evaluator_TPOW, Evaluator_TPWE, Evaluator_TPWEC
