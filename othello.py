...
if __name__ == '__main__':
    ...
    b = ['User1', 'Unselfish', 'Random', 'Greedy', 'SlowStarter', 'Table', 'MinMax', 'NegaMax', 'AlphaBeta', 'AB_T', 'AB_TI']
    w = ['User2', 'Unselfish', 'Random', 'Greedy', 'SlowStarter', 'Table', 'MinMax', 'NegaMax', 'AlphaBeta', 'AB_T', 'AB_TI']
