...
class Evaluator_T(AbstractEvaluator):
    ...
    def __init__(self, size=8, corner=50, c=-20, a=0, b=-1, x=-25, o=-5):
        self.scorer = TableScorer(size, corner, c, a, b, x, o)  # Tableによる評価値算出
...
class Evaluator_TP(AbstractEvaluator):
    ...
    """
    def __init__(self, size=8, corner=50, c=-20, a=0, b=-1, x=-25, o=-5, wp=5):
        self.t = Evaluator_T(size,corner, c, a, b, x, o)
...
class Evaluator_TPO(AbstractEvaluator):
    ...
    """
    def __init__(self, size=8, corner=50, c=-20, a=0, b=-1, x=-25, o=-5, wp=5, wo=-0.75):
        self.t = Evaluator_T(size, corner, c, a, b, x, o)
        self.p = Evaluator_P(wp)
...
class Evaluator_TPW(AbstractEvaluator):
    ...
    """
    def __init__(self, size=8, corner=50, c=-20, a=0, b=-1, x=-25, o=-5, wp=5, ww=10000):
        self.t = Evaluator_T(size, corner, c, a, b, x, o)
        self.p = Evaluator_P(wp)
...
class Evaluator_TPOW(Evaluator_TPO):
    ...
    """
    def __init__(self, size=8, corner=50, c=-20, a=0, b=-1, x=-25, o=-5, wp=5, wo=-0.75, ww=10000):
        self.t = Evaluator_T(size, corner, c, a, b, x, o)
        self.p = Evaluator_P(wp)
        self.o = Evaluator_O(wo)
        self.w = Evaluator_W(ww)
