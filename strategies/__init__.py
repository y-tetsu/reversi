...
from strategies.negamax import NegaMax1, NegaMax2, NegaMax3, NegaMax4, NegaMax1_TPOW, NegaMax2_TPOW, NegaMax3_TPOW, NegaMax4_TPOW
from strategies.alphabeta import AlphaBeta1, AlphaBeta2, AlphaBeta3, AlphaBeta4, AlphaBeta1_TPOW, AlphaBeta2_TPOW, AlphaBeta3_TPOW, AlphaBeta4_TPOW, AB_T4, AB_TI
from strategies.iterative import AbI_TPOW, AbI_B_TPOW
