...
CPUの持ち時間は大体0.5秒までとしています。
 ...
 |AlphaBeta |アルファベータ(ネガアルファ)法で4手先を読んで手を選びます。| ★★★ |
 |FullReading |終盤残り9手からは最終局面の石差を読んで手を選びます。| ★★★ |
 |Joseki |序盤は定石通りに手を選びます。| ★★★ |
 |Iterative |反復深化法で持ち時間の限り徐々に深く手を読みます。<br>反復深化の際は前回の深さで最も評価が高かった手を最初に調べます。| ★★★★ |
 |NegaScout |ネガスカウト法に反復深化法を適用して手を選びます。| ★★★★ |
