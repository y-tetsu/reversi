...
class ScreenBoard:
    ...
    def __init__(self, canvas, size, cputime, assist):
        ...
        # 低速モードの表示
        slowmode_text = '■'
        if BitBoardMethods.SLOW_MODE1 or BitBoardMethods.SLOW_MODE2 or BitBoardMethods.SLOW_MODE3 or BitBoardMethods.SLOW_MODE4 or BitBoardMethods.SLOW_MODE5 or TableMethods.SLOW_MODE:
            self.text = canvas.create_text(
                SLOWMODE_OFFSET_X,
                SLOWMODE_OFFSET_Y,
                text=slowmode_text,
